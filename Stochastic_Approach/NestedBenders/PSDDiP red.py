...
K_list = [1, 2, 3, 4, 5, 6, 7, 8, 10, 15, 500]

price_setting = 'cloudy'  
...
if __name__ == "__main__":
    ...
    psddip_multi_6 = PSDDiPModel_multicut(
            STAGE = T,
            DA_params=P_da_evaluate,
            RT_params=Sceanrio_tree_evaluate,
            DA_params_reduced=Reduced_P_da[l_3],
